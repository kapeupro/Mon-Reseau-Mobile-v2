...
export default function ButtonServicesRoute() {
  const { serviceRoute, setServiceRoute } = useServiceRouteStore();
  ...
  return (
    <>
      ...
      <ButtonServices service={serviceRoute} setService={setServiceRoute} />
    </>
  );
}
